...
!(function (t, e) {
  ...
  class At extends H {
    ...
    to(t) {
      this._activeElement = Y.findOne(Et, this._element);
      const e = this._getItemIndex(this._activeElement);
      if (t > this._items.length - 1 || t < 0) return;
      if (this._isSliding)
        return void P.one(this._element, ct, () => this.to(t));
    ...
    _handleSwipe() {
      ...
      (this.touchDeltaX = 0), e && this._slide(e > 0 ? rt : ot);
    }
    _addEventListeners() {
      this._config.keyboard && P.on(this._element, ht, (t) => this._keydown(t)),
        "hover" === this._config.pause &&
          (P.on(this._element, dt, (t) => this.pause(t)),
          P.on(this._element, ut, (t) => this.cycle(t))),
        this._config.touch &&
          this._touchSupported &&
    ...
    _addTouchEventListeners() {
      ...
      Y.find(".carousel-item img", this._element).forEach((t) => {
        ...
        this._pointerEvent
          ? (P.on(this._element, mt, (t) => e(t)),
            P.on(this._element, _t, (t) => n(t)),
            this._element.classList.add("pointer-event"))
          : (P.on(this._element, ft, (t) => e(t)),
            P.on(this._element, pt, (t) => i(t)),
    ...
    _triggerSlideEvent(t, e) {
      const i = this._getItemIndex(t),
        n = this._getItemIndex(Y.findOne(Et, this._element));
      return P.trigger(this._element, lt, {
        relatedTarget: t,
        direction: e,
        from: n,
        to: i,
      ...
      if (this._indicatorsElement) {
        ...
        for (let e = 0; e < i.length; e++)
          if (
            ...
            i[e].classList.add(wt), i[e].setAttribute("aria-current", "true");
            break;
          }
      }
    }
    _updateInterval() {
      const t = this._activeElement || Y.findOne(Et, this._element);
      if (!t) return;
    ...
    _slide(t, e) {
      ...
      } else n.classList.remove(wt), o.classList.add(wt), (this._isSliding = !1), f();
      a && this.cycle();
    }
    _directionToOrder(t) {
      return [rt, ot].includes(t)
        ? g()
          ? t === ot
            ? st
            : nt
  ...
  const Tt = "collapse",
    Ot = "bs.collapse",
    Ct = `.${Ot}`,
    kt = { toggle: !0, parent: null },
    Lt = { toggle: "boolean", parent: "(null|element)" },
    xt = `show${Ct}`,
    $t = `shown${Ct}`,
    Dt = `hide${Ct}`,
    St = `hidden${Ct}`,
    Nt = `click${Ct}.data-api`,
    It = "show",
    Pt = "collapse",
    jt = "collapsing",
    Mt = "collapsed",
  ...
  class Rt extends H {
    ...
    show() {
      ...
      if (this._config.parent) {
        const t = Y.find(Ht, this._config.parent);
        e = Y.find(
      ...
      if (e.length) {
        ...
        if (((t = n ? Rt.getInstance(n) : null), t && t._isTransitioning))
          return;
      }
      if (P.trigger(this._element, xt).defaultPrevented) return;
      e.forEach((e) => {
        i !== e && Rt.getOrCreateInstance(e, { toggle: !1 }).hide(),
          t || M.set(e, Ot, null);
      });
      ...
      this._queueCallback(
        () => {
          (this._isTransitioning = !1),
            ...
            this._element.classList.add(Pt, It),
    ...
    hide() {
      if (this._isTransitioning || !this._isShown()) return;
      if (P.trigger(this._element, Dt).defaultPrevented) return;
      ...
      (this._element.style[t] = `${
        ...
        u(this._element),
        this._element.classList.add(jt),
        this._element.classList.remove(Pt, It);
    ...
    _getConfig(t) {
      return (
        ((t = { ...kt, ...X.getDataAttributes(this._element), ...t }).toggle =
          Boolean(t.toggle)),
        (t.parent = r(t.parent)),
        a(Tt, t, Lt),
        t
    ...
    _addAriaAndCollapsedClass(t, e) {
      t.length &&
        t.forEach((t) => {
          e ? t.classList.remove(Mt) : t.classList.add(Mt),
  ...
  P.on(document, Nt, Bt, function (t) {
    ("A" === t.target.tagName ||
  ...
  var Wt = "top",
    ...
    Gt = "popper",
    Zt = "reference",
    Jt = Vt.reduce(function (t, e) {
      return t.concat([e + "-" + Kt, e + "-" + Xt]);
    }, []),
    te = [].concat(Vt, [Ut]).reduce(function (t, e) {
      return t.concat([e, e + "-" + Kt, e + "-" + Xt]);
    }, []),
    ee = "beforeRead",
    ie = "read",
    ne = "afterRead",
  ...
  function fe(t) {
    return t instanceof ue(t).Element || t instanceof Element;
  }
  function pe(t) {
    return t instanceof ue(t).HTMLElement || t instanceof HTMLElement;
  }
  function ge(t) {
    return (
  ...
  function Te(t) {
    return "html" === de(t)
      ? t
      : t.assignedSlot || t.parentNode || (ge(t) ? t.host : null) || Ae(t);
  }
  function Oe(t) {
    return pe(t) && "fixed" !== we(t).position ? t.offsetParent : null;
  }
  function Ce(t) {
    for (var e = ue(t), i = Oe(t); i && Ee(i) && "static" === we(i).position; )
      i = Oe(i);
    return i &&
      ("html" === de(i) || ("body" === de(i) && "static" === we(i).position))
      ? e
      : i ||
          (function (t) {
  ...
  const Ie = {
    ...
    fn: function (t) {
      var e,
        ...
        a = _e(i.placement),
        l = ke(a),
        c = [Ft, qt].indexOf(a) >= 0 ? "height" : "width";
      if (o && r) {
        var h = (function (t, e) {
            return Se(
              "number" !=
  ...
  function Me(t) {
      ...
      d =
        !0 === h
          ? (function (t) {
              ...
              return { x: $e($e(e * n) / n) || 0, y: $e($e(i * n) / n) || 0 };
            })(r)
          : "function" == typeof h
          ? h(r)
          : r,
    ...
    if (c) {
      var w = Ce(i),
        ...
        A = "clientWidth";
      w === ue(i) &&
        "static" !== we((w = Ae(i))).position &&
        "absolute" === a &&
        ((E = "scrollHeight"), (A = "scrollWidth")),
        (s !== Wt && ((s !== Ft && s !== qt) || o !== Xt)) ||
          ((b = zt), (g -= w[E] - n.height), (g *= l ? 1 : -1)),
        (s !== Ft && ((s !== Wt && s !== zt) || o !== Xt)) ||
          ((v = qt), (f -= w[A] - n.width), (f *= l ? 1 : -1));
    }
    var T,
      O = Object.assign({ position: a }, c && je);
    return l
      ? Object.assign(
          {},
          O,
  ...
  const Re = {
    ...
    effect: function (t) {
      ...
      return (
        ...
        a && l.addEventListener("resize", i.update, Be),
        function () {
          o &&
            c.forEach(function (t) {
              t.removeEventListener("scroll", i.update, Be);
            }),
            a && l.removeEventListener("resize", i.update, Be);
        }
      );
    },
    data: {},
  ...
  function Ve(t) {
    return ve(Ae(t)).left + Ue(t).scrollLeft;
  }
  function Ke(t) {
    var e = we(t),
      i = e.overflow,
  ...
  function Ye(t, e) {
    ...
    var n = Xe(t),
      ...
      o = ue(n),
      r = s ? [o].concat(o.visualViewport || [], Ke(n) ? n : []) : n,
      a = e.concat(r);
    return s ? a : a.concat(Ye(Te(r)));
  }
  function Qe(t) {
      ...
      : Qe(
          (function (t) {
            var e,
              ...
              l = -n.scrollTop;
            return (
              "rtl" === we(s || i).direction &&
                (a += Le(i.clientWidth, s ? s.clientWidth : 0) - o),
    ...
    var n =
        "clippingParents" === e
          ? (function (t) {
              var e = Ye(Te(t)),
                i =
                  ["absolute", "fixed"].indexOf(we(t).position) >= 0 && pe(t)
                    ? Ce(t)
                    : t;
              return fe(i)
                ? e.filter(function (t) {
                    return fe(t) && ye(t, i) && "body" !== de(t);
                  })
                : [];
            })(t)
          : [].concat(e),
      ...
      r = s.reduce(function (e, i) {
        ...
        return (
          ...
          (e.right = xe(n.right, e.right)),
          (e.bottom = xe(n.bottom, e.bottom)),
  ...
  function ti(t, e) {
    ...
    var i = e,
      ...
      f = i.padding,
      p = void 0 === f ? 0 : f,
      g = Se("number" != typeof p ? p : Ne(p, Vt)),
      m = h === Gt ? Zt : Gt,
      _ = t.rects.popper,
      v = t.elements[u ? m : h],
      b = Ze(fe(v) ? v : v.contextElement || Ae(t.elements.popper), r, l),
      y = ve(t.elements.reference),
      w = Je({ reference: y, element: _, strategy: "absolute", placement: s }),
      E = Qe(Object.assign({}, _, w)),
      A = h === Gt ? E : y,
      T = {
    ...
    if (h === Gt && O) {
      ...
      Object.keys(T).forEach(function (t) {
        var e = [qt, zt].indexOf(t) >= 0 ? 1 : -1,
          i = [Wt, zt].indexOf(t) >= 0 ? "y" : "x";
        T[t] += C[i] * e;
      });
    }
    return T;
  ...
  function si(t) {
    return [Wt, qt, zt, Ft].some(function (e) {
      return t[e] >= 0;
    });
  }
  const oi = {
    ...
    fn: function (t) {
      var e = t.state,
        ...
        r = ti(e, { elementContext: "reference" }),
        a = ti(e, { altBoundary: !0 }),
        l = ni(r, n),
        c = ni(a, s, o),
        h = si(l),
        d = si(c);
  ...
  const ri = {
    ...
    fn: function (t) {
      var e = t.state,
        ...
        s = i.offset,
        o = void 0 === s ? [0, 0] : s,
        r = te.reduce(function (t, i) {
          return (
            (t[i] = (function (t, e, i) {
              var n = _e(t),
                s = [Ft, Wt].indexOf(n) >= 0 ? -1 : 1,
                o =
                  "function" == typeof i
              ...
              return (
                (r = r || 0),
                (a = (a || 0) * s),
                [Ft, qt].indexOf(n) >= 0 ? { x: a, y: r } : { x: r, y: a }
              );
            })(i, e.rects, o)),
            t
          );
  ...
  const li = {
    ...
    fn: function (t) {
      var e = t.state,
        ...
        p = i.tetherOffset,
        g = void 0 === p ? 0 : p,
        m = ti(e, { boundary: l, rootBoundary: c, padding: d, altBoundary: h }),
        _ = _e(e.placement),
        v = Pe(e.placement),
        b = !v,
        y = ke(_),
      ...
      if (E) {
        if (o || a) {
          var k = "y" === y ? Wt : Ft,
            ...
            F = e.elements.arrow && Ce(e.elements.arrow),
            ...
            X = E[y] + q - V;
          if (o) {
            var Y = De(f ? xe(D, K) : D, $, f ? Le(S, X) : S);
            (E[y] = Y), (C[y] = Y - $);
          }
          if (a) {
            var Q = "x" === y ? Wt : Ft,
              ...
              J = Z + m[Q],
              tt = Z - m[G],
              et = De(f ? xe(J, K) : J, Z, f ? Le(tt, X) : tt);
            (E[w] = et), (C[w] = et - Z);
          }
        }
        e.modifiersData[n] = C;
        ...
        (("body" !== de(e) || Ke(r)) &&
          (l =
            (s = e) !== ue(s) && pe(s)
              ...
              : Ue(s)),
        pe(e)
          ? (((c = ve(e)).x += e.clientLeft), (c.y += e.clientTop))
          : r && (c.x = Ve(r))),
      {
        ...
        h = {
          ...
          forceUpdate: function () {
            if (!c) {
              ...
              if (ui(e, i)) {
                (a.rects = {
                  reference: ci(e, Ce(i), "fixed" === a.options.strategy),
                  popper: be(i),
                }),
                  (a.reset = !1),
  ...
  var pi = fi(),
    gi = fi({ defaultModifiers: [Re, ai, He, me] }),
    mi = fi({ defaultModifiers: [Re, ai, He, me, ri, ii, li, Ie, oi] });
  const _i = Object.freeze({
    ...
    Pi = ".dropdown-menu",
    ji = g() ? "top-end" : "top-start",
    Mi = g() ? "top-start" : "top-end",
    Hi = g() ? "bottom-end" : "bottom-start",
    Bi = g() ? "bottom-start" : "bottom-end",
    Ri = g() ? "left-start" : "right-start",
    Wi = g() ? "right-start" : "left-start",
    zi = {
      offset: [0, 2],
  ...
  class Fi extends H {
    ...
    show() {
      ...
      if (P.trigger(this._element, Li, t).defaultPrevented) return;
    ...
    _completeHide(t) {
      P.trigger(this._element, Ci, t).defaultPrevented ||
        ("ontouchstart" in document.documentElement &&
          []
            .concat(...document.body.children)
    ...
    _createPopper(t) {
      ...
      (this._popper = mi(e, this._menu, i)),
    ...
    _getMenuElement() {
      return Y.next(this._element, Pi)[0];
    }
    _getPlacement() {
      ...
      return t.classList.contains("dropup") ? (e ? Mi : ji) : e ? Bi : Hi;
    }
    _detectNavbar() {
    ...
    static dataApiKeydownHandler(t) {
      if (
        /input|textarea/i.test(t.target.tagName)
          ? t.key === Ei ||
            (t.key !== wi &&
              ((t.key !== Ti && t.key !== Ai) || t.target.closest(Pi)))
          : !Oi.test(t.key)
      )
        return;
      const e = this.classList.contains(Ni);
      if (!e && t.key === wi) return;
      if ((t.preventDefault(), t.stopPropagation(), c(this))) return;
      const i = this.matches(Ii) ? this : Y.prev(this, Ii)[0],
        n = Fi.getOrCreateInstance(i);
      if (t.key !== wi)
        return t.key === Ai || t.key === Ti
          ? (e || n.show(), void n._selectMenuItem(t))
          : void ((e && t.key !== Ei) || Fi.clearMenus());
      n.hide();
    }
  }
  P.on(document, Di, Ii, Fi.dataApiKeydownHandler),
    P.on(document, Di, Pi, Fi.dataApiKeydownHandler),
    P.on(document, $i, Fi.clearMenus),
    P.on(document, Si, Fi.clearMenus),
    P.on(document, $i, Ii, function (t) {
  ...
  class Ki {
    ...
    hide() {
      ...
      this._disableOverFlow(),
        ...
        this._setElementAttributes(Vi, "marginRight", (e) => e - t);
    }
    _disableOverFlow() {
    ...
    reset() {
      this._resetElementAttributes(this._element, "overflow"),
        ...
        this._resetElementAttributes(Vi, "marginRight");
    }
  ...
  class Ji {
    ...
    _getConfig(t) {
      return (
        ((t = { ...Xi, ...("object" == typeof t ? t : {}) }).rootElement = r(
          t.rootElement
        )),
        a(Qi, t, Yi),
        t
  ...
  class an {
    ...
    activate() {
      ...
      this._isActive ||
        (e && t.focus(),
        P.off(document, nn),
        P.on(document, sn, (t) => this._handleFocusin(t)),
        P.on(document, on, (t) => this._handleKeydown(t)),
        (this._isActive = !0));
    }
    deactivate() {
      this._isActive && ((this._isActive = !1), P.off(document, nn));
    }
    _handleFocusin(t) {
      const { target: e } = t,
  ...
  const ln = "modal",
    ...
    vn = `resize${cn}`,
    bn = `click.dismiss${cn}`,
    yn = `keydown.dismiss${cn}`,
    wn = `mouseup.dismiss${cn}`,
    En = `mousedown.dismiss${cn}`,
    An = `click${cn}.data-api`,
    Tn = "modal-open",
    On = "show",
    Cn = "modal-static";
  class kn extends H {
    ...
    show(t) {
      ...
      P.trigger(this._element, mn, { relatedTarget: t }).defaultPrevented ||
        ...
        P.on(this._dialog, En, () => {
          P.one(this._element, wn, (t) => {
    ...
    hide() {
      if (!this._isShown || this._isTransitioning) return;
      if (P.trigger(this._element, fn).defaultPrevented) return;
      this._isShown = !1;
      ...
      t && (this._isTransitioning = !0),
        ...
        P.off(this._element, bn),
        P.off(this._dialog, En),
        this._queueCallback(() => this._hideModal(), this._element, t);
    }
    dispose() {
      [window, this._dialog].forEach((t) => P.off(t, cn)),
      ...
      this._queueCallback(
        () => {
          this._config.focus && this._focustrap.activate(),
            (this._isTransitioning = !1),
            P.trigger(this._element, _n, { relatedTarget: t });
        },
        this._dialog,
        e
      );
    ...
    _setResizeEvent() {
      this._isShown
        ? P.on(window, vn, () => this._adjustDialog())
        : P.off(window, vn);
    }
    _hideModal() {
  ...
  P.on(document, An, '[data-bs-toggle="modal"]', function (t) {
    const e = n(this);
  ...
  const Ln = "offcanvas",
    ...
    $n = ".data-api",
    Dn = `load${xn}${$n}`,
    Sn = { backdrop: !0, keyboard: !0, scroll: !1 },
  ...
  class zn extends H {
    ...
    show(t) {
      ...
      if (P.trigger(this._element, jn, { relatedTarget: t }).defaultPrevented)
        return;
      (this._isShown = !0),
      ...
      this._queueCallback(
        () => {
          this._config.scroll || this._focustrap.activate(),
            P.trigger(this._element, Mn, { relatedTarget: t });
        },
        this._element,
        !0
      );
    ...
    hide() {
      if (!this._isShown) return;
      if (P.trigger(this._element, Hn).defaultPrevented) return;
      this._focustrap.deactivate(),
        this._element.blur(),
        (this._isShown = !1),
  ...
  P.on(document, Rn, '[data-bs-toggle="offcanvas"]', function (t) {
    ...
    const i = Y.findOne(Pn);
    i && i !== e && zn.getInstance(i).hide();
    zn.getOrCreateInstance(e).toggle(this);
  }),
    P.on(window, Dn, () =>
      Y.find(Pn).forEach((t) => zn.getOrCreateInstance(t).show())
    ),
    B(zn),
    m(zn);
  const qn = new Set([
    ...
    Vn = (t, e) => {
      ...
      if (e.includes(i))
        return (
          !qn.has(i) || Boolean(Fn.test(t.nodeValue) || Un.test(t.nodeValue))
        );
  ...
  function Xn(t, e, i) {
    ...
    for (let t = 0, i = s.length; t < i; t++) {
      ...
      const o = [].concat(...i.attributes),
        r = [].concat(e["*"] || [], e[n] || []);
      o.forEach((t) => {
        Vn(t, r) || i.removeAttribute(t.nodeName);
      });
    }
  ...
  class ds extends H {
    ...
    dispose() {
      clearTimeout(this._timeout),
        P.off(this._element.closest(as), ls, this._hideModalHandler),
    ...
    show() {
      ...
      M.set(n, this.constructor.DATA_KEY, this),
        ...
        this._popper
          ? this._popper.update()
          : (this._popper = mi(this._element, n, this._getPopperConfig(r))),
        n.classList.add(ns);
    ...
    getTipElement() {
      ...
      return (
        this.setContent(e), e.classList.remove(is, ns), (this.tip = e), this.tip
      );
    }
    setContent(t) {
      this._sanitizeAndSetContent(t, this.getTitle(), rs);
    }
        ...
        return o(e)
          ...
          : void (this._config.html
              ? (this._config.sanitize &&
                  (e = Xn(e, this._config.allowList, this._config.sanitizeFn)),
                (t.innerHTML = e))
              : (t.textContent = e));
    }
    getTitle() {
    ...
    _setListeners() {
      this._config.trigger.split(" ").forEach((t) => {
        ...
        P.on(this._element.closest(as), ls, this._hideModalHandler),
        this._config.selector
          ? (this._config = {
              ...this._config,
              trigger: "manual",
    ...
    _enter(t, e) {
      (e = this._initializeOnDelegatedTarget(t, e)),
        t && (e._activeTrigger["focusin" === t.type ? hs : cs] = !0),
    ...
    _getConfig(t) {
      ...
      return (
        ...
        a(Yn, t, this.constructor.DefaultType),
  ...
  const us = ".bs.popover",
    ...
    gs = {
      ...
      SHOW: `show${us}`,
      SHOWN: `shown${us}`,
      INSERTED: `inserted${us}`,
      CLICK: `click${us}`,
      FOCUSIN: `focusin${us}`,
      FOCUSOUT: `focusout${us}`,
      MOUSEENTER: `mouseenter${us}`,
      MOUSELEAVE: `mouseleave${us}`,
    };
  class ms extends ds {
    static get Default() {
      return fs;
  ...
  class $s extends H {
    constructor(t, e) {
      super(t),
        ...
        P.on(this._scrollElement, Es, () => this._process()),
        this.refresh(),
        this._process();
    }
    static get Default() {
    ...
    refresh() {
      const t =
          this._scrollElement === this._scrollElement.window ? "offset" : xs,
        e = "auto" === this._config.method ? t : this._config.method,
        n = e === xs ? this._getScrollTop() : 0;
      (this._offsets = []),
        (this._targets = []),
        (this._scrollHeight = this._getScrollHeight());
      Y.find(Ls, this._config.target)
        .map((t) => {
          const s = i(t),
    ...
    dispose() {
      P.off(this._scrollElement, vs), super.dispose();
    }
    _getConfig(t) {
      return (
        ((t = {
      ...
      i.classList.add(Os),
        i.classList.contains(Ts)
          ...
          : Y.parents(i, ".nav, .list-group").forEach((t) => {
              Y.prev(t, `${Cs}, ${ks}`).forEach((t) => t.classList.add(Os)),
                Y.prev(t, ".nav-item").forEach((t) => {
                  Y.children(t, Cs).forEach((t) => t.classList.add(Os));
                });
            }),
        P.trigger(this._scrollElement, ws, { relatedTarget: t });
    }
    _clear() {
      Y.find(Ls, this._config.target)
        .filter((t) => t.classList.contains(Os))
        .forEach((t) => t.classList.remove(Os));
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  P.on(window, As, () => {
    Y.find('[data-bs-spy="scroll"]').forEach((t) => new $s(t));
  }),
    m($s);
  const Ds = ".bs.tab",
    Ss = `hide${Ds}`,
  ...
  class zs extends H {
    ...
    show() {
      ...
      if (i) {
        const e = "UL" === i.nodeName || "OL" === i.nodeName ? Ws : Rs;
        (t = Y.find(e, i)), (t = t[t.length - 1]);
      }
      const s = t ? P.trigger(t, Ss, { relatedTarget: this._element }) : null;
      if (
        P.trigger(this._element, Is, { relatedTarget: t }).defaultPrevented ||
        (null !== s && s.defaultPrevented)
      )
        return;
      this._activate(this._element, i);
      const o = () => {
        P.trigger(t, Ns, { relatedTarget: this._element }),
          P.trigger(this._element, Ps, { relatedTarget: t });
      };
    ...
    _activate(t, e, i) {
      const n = (
        ...
        s = i && n && n.classList.contains(Hs),
        o = () => this._transitionComplete(t, n, i);
      n && s ? (n.classList.remove(Bs), this._queueCallback(o, t, !0)) : o();
    }
    _transitionComplete(t, e, i) {
      if (e) {
        e.classList.remove(Ms);
        const t = Y.findOne(":scope > .dropdown-menu .active", e.parentNode);
        t && t.classList.remove(Ms),
      ...
      t.classList.add(Ms),
        ...
        u(t),
        t.classList.contains(Hs) && t.classList.add(Bs);
      let n = t.parentNode;
      if (
        ...
        e && Y.find(".dropdown-toggle", e).forEach((t) => t.classList.add(Ms)),
  ...
  P.on(
    ...
    function (t) {
      if ((["A", "AREA"].includes(this.tagName) && t.preventDefault(), c(this)))
        return;
      zs.getOrCreateInstance(this).show();
    }
  ),
    m(zs);
  const qs = "toast",
  ...
  class so extends H {
    ...
    show() {
      if (P.trigger(this._element, Gs).defaultPrevented) return;
      this._clearTimeout(),
    ...
    hide() {
      if (!this._element.classList.contains(to)) return;
    ...
    dispose() {
      this._clearTimeout(),
        this._element.classList.contains(to) &&
          this._element.classList.remove(to),
        super.dispose();
    }
    _getConfig(t) {
      return (
        ...
        a(qs, t, this.constructor.DefaultType),
        t
      );
    }
    _maybeScheduleHide() {
    ...
    _setListeners() {
      P.on(this._element, Us, (t) => this._onInteraction(t, !0)),
        ...
        P.on(this._element, Xs, (t) => this._onInteraction(t, !1));
    }
    _clearTimeout() {
